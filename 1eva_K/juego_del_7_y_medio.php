...
if (isset($_GET['Jugar']) || isset($_GET['pedir_carta'])) {
    ...
    if ($_GET['pedir_carta'] == 1 || $_GET['intento'] == 1) 
    {
        ...
        header("Location:juego_del_7_y_medio.php?nombre=$nombre&intento=0&numero=$numero&numero_banca=$numero_banca&baraja=$baraja");
...
if ($intento == 1) {
    ...
    echo "
            <div id='container_nombre'>
                <form name='formulario' action='juego_del_7_y_medio.php' method='GET' enctype='application/x-www-form-urlencoded'>
    ...
    echo "<div id='container_enlaces'>
            <a href='juego_del_7_y_medio.php?nombre=$nombre&intento=0&numero=$numero&numero_banca=$numero_banca&pedir_carta=1&baraja=$baraja'>Pedir carta</a>
            <a href='juego_del_7_y_medio.php?nombre=$nombre&intento=0&numero=$numero&numero_banca=$numero_banca&pedir_carta=0&baraja=$baraja'>Plantarse</a>
        </div>";
} else {
...
function comprobarResultado($nombre, $numero, $numero_banca)
{
    ...
    echo "<a href='juego_del_7_y_medio.php' title='Volver a jugar'>Volver a jugar</a>";
}
