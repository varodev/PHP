                ...
                if (mysqli_select_db($conexion, $bbdd)) {
                    ...
                    if (mysqli_errno($conexion) != 0) {
                        ...
                        while ($fila = mysqli_fetch_array($resultado)) {
                            //echo $fila['nombre'] $fila['apellidos'] $fila['telefono'];
                            //echo "<p>$fila[nombre] $fila[apellidos]</p>";
                            echo "<p><a href='mostrar_ficha.php?codigo=$fila[cod_contacto]&nombre=$fila[nombre]&apellidos=$fila[apellidos]'>$fila[cod_contacto] $fila[nombre] $fila[apellidos]</a></p>";
                        }
                    }
                }
