            ...
            if (mysqli_select_db($conexion, $bbdd)) {
                if (mysqli_errno($conexion) != 0) {
                    ...
                    if (isset($_POST['editar'])) {
                        ...
                        $fila_album = mysqli_fetch_array($resultado);
                        ...
                        if (mysqli_errno($conexion) != 0) {
                            ...
                            $cod_album = $fila_album['cod_album'];
                            $titulo = $fila_album['titulo'];
                            $fecha = $fila_album['fecha'];
