...
<body>
	...
	if (isset($_GET['enviar'])) {
		...
		if (isset($_GET['dni'])) {
			...
			header("Location:0.alvaro_moreno_validar_dni.php?nombre=$nombre_usuario&dni=$dni_usuario&intento=$intento&resultado=$resultado");
		}
	}
	...
	function comprobarResultado($resultado, $intento){
		...
		if ($resultado == 0 && $intento <= 0) {
			...
			echo "<a href='0.alvaro_moreno_validar_dni.php' title='Volver a intentarlo'>Volver a intentarlo</a>";
			...
			echo "<a href='0.alvaro_moreno_validar_dni.php' title='v'>Volver al formulario</a>";
		}
	}
	...
	if ($intento >= 0 && $resultado != 0) {
		echo "
            <div id='container_numero'>
                <h1>Comprobar dni</h1>
                <form name='formulario' action='0.alvaro_moreno_validar_dni.php' method='GET' enctype='application/x-www-form-urlencoded'>
